...
function ModalCancel(props) {
  ...
  useEffect(() => {
    setReason_HTML(`<p>Tiếc rằng chúng tôi phải gửi thông báo này đến quý khách. Chúng tôi muốn thông báo rằng do lịch đăng ký của tour của quý khách không đạt đủ số lượng người cần thiết, vì vậy chúng tôi buộc phải hủy tour đó.</p>
    <p>Chúng tôi hiểu rằng điều này có thể gây không tiện cho kế hoạch của quý khách và <strong>xin chân thành xin lỗi về sự bất tiện này</strong>. Để đền bù cho sự phiền toái này, chúng tôi muốn đề xuất hai lựa chọn cho quý khách:</p>
    <p><strong>Chuyển Tour</strong>: Quý khách có thể chọn chuyển sang một tour khác trong danh sách tour của chúng tôi, nếu có sẵn. Chúng tôi sẽ hỗ trợ quý khách trong quá trình chuyển đổi này và cung cấp thông tin chi tiết về các tour khác.</p>
    <p><strong>Hoàn Tiền</strong>: Nếu quý khách không muốn chuyển sang tour khác, chúng tôi sẽ hoàn lại toàn bộ số tiền đã thanh toán cho tour bị hủy.
    Xin vui lòng liên hệ với chúng tôi qua số điện thoại hoặc email được cung cấp trong thông báo này để thông báo về lựa chọn của quý khách hoặc nếu có bất kỳ câu hỏi nào khác. Chúng tôi sẽ làm hết sức mình để giúp đỡ và đảm bảo rằng quý khách có trải nghiệm du lịch tốt nhất có thể.</p>
    <p><strong>Một lần nữa, chúng tôi thành thật xin lỗi về sự bất tiện này và hy vọng nhận được sự hiểu thông cảm từ phía quý khách.</strong></p>
    `);

    setReason_TEXT(`Tiếc rằng chúng tôi phải gửi thông báo này đến quý khách. Chúng tôi muốn thông báo rằng do lịch đăng ký của tour của quý khách không đạt đủ số lượng người cần thiết, vì vậy chúng tôi buộc phải hủy tour đó. 
